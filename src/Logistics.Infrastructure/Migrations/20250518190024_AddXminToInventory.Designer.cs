...
namespace Logistics.Infrastructure.Migrations
{
    ...
    [Migration("20250518190024_AddXminToInventory")]
    partial class AddXminToInventory
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Logistics.Infrastructure.DatabaseEntity.Delivery.RouteEntity", b =>
                {
                    ...
                    b.OwnsOne("Logistics.Domain.ValueObjects.Money", "Cost", b1 =>
                        {
                            b1.Property<int>("RouteEntityId")
                                .HasColumnType("integer");
